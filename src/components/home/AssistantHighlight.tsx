...
const AssistantHighlight = () => {
    ...
    return (
        <section ref={sectionRef} id="novabot" className="container-shell py-18">
            <div className="grid gap-8 rounded-[2rem] border border-warm bg-primary p-8 text-on-primary shadow-[0_28px_90px_rgba(0,0,0,0.34)] lg:grid-cols-[0.95fr_1.05fr] lg:p-10">
                <div data-reveal className="space-y-4">
                    ...
                    <p className="max-w-xl text-sm leading-7 text-on-primary/75 sm:text-base">
                        Recomienda combinaciones con productos del catalogo sin afectar la integracion con Gemini.
                    </p>
                </div>

                <div className="grid gap-4 sm:grid-cols-2">
                    <div data-reveal className="rounded-[1.5rem] border border-on-primary/12 bg-on-primary/6 p-5">
                        <p className="text-sm uppercase tracking-[0.22em] text-accent">Capacidades</p>
                        <ul className="mt-4 space-y-3 text-sm leading-6 text-on-primary/80">
                    ...
                    <div data-reveal className="rounded-[1.5rem] border border-on-primary/12 bg-on-primary/6 p-5">
                        ...
                        <div className="mt-4 space-y-3 text-sm leading-6 text-on-primary/80">
