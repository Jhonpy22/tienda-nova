...
const CartIcon = () => {
    ...
    return (
        <button
            ...
            className="relative flex h-9 w-9 items-center justify-center rounded-full text-text-muted transition-colors duration-200 hover:bg-sand hover:text-primary"
        >
            {/* Ícono de bolsa */}
            <svg
