...
const hombrePantalones: ProductSeed[] = [
    ...
    { nombre: 'Jean Straight Azul Vintage', precio: 27990, tallas: ['M', 'L', 'XL'], colores: ['Azul vintage'], imagen: 'https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Denim recto con lavado clasico.' },
    { nombre: 'Pantalon Chino Grafito', precio: 28490, tallas: ['S', 'M', 'L'], colores: ['Grafito'], imagen: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Chino pulido para oficina y ciudad.' },
    { nombre: 'Pantalon Slim Arena Premium', precio: 29990, tallas: ['M', 'L'], colores: ['Arena'], imagen: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Slim fit con tela de tacto suave.', nuevo: true },
    { nombre: 'Jean Tapered Gris Humo', precio: 27490, tallas: ['M', 'L', 'XL'], colores: ['Gris humo'], imagen: 'https://images.unsplash.com/photo-1602293589930-45aad59ba3ab?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Tapered oscuro para looks casuales.' },
    { nombre: 'Pantalon Sastre Piedra', precio: 31490, tallas: ['M', 'L', 'XL'], colores: ['Piedra'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Sastre claro con lectura refinada.' },
    { nombre: 'Chino Terracota Urbano', precio: 26990, tallas: ['S', 'M', 'L'], colores: ['Terracota'], imagen: 'https://images.unsplash.com/photo-1517445312882-bc9910d016b7?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Color calido para combinaciones casuales.' },
    { nombre: 'Jean Recto Azul Ceniza', precio: 25990, tallas: ['M', 'L'], colores: ['Azul ceniza'], imagen: 'https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Jean comodo con lavado suave.' },
    { nombre: 'Pantalon Formal Negro Premium', precio: 32990, tallas: ['M', 'L', 'XL'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Base formal de linea limpia.' },
    { nombre: 'Chino Azul Hielo', precio: 27490, tallas: ['S', 'M', 'L'], colores: ['Azul hielo'], imagen: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Chino liviano para clima calido.' },
    { nombre: 'Jean Black Wash Moderno', precio: 28990, tallas: ['M', 'L'], colores: ['Black wash'], imagen: 'https://images.unsplash.com/photo-1602293589930-45aad59ba3ab?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Lavado negro con perfil contemporaneo.' },
    { nombre: 'Pantalon Stretch Azul Tinta', precio: 30490, tallas: ['M', 'L', 'XL'], colores: ['Azul tinta'], imagen: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Stretch comodo con apariencia sobria.' },
    { nombre: 'Pantalon Chino Verde Seco', precio: 27990, tallas: ['S', 'M', 'L'], colores: ['Verde seco'], imagen: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Chino actual de tono natural.' },
    { nombre: 'Jean Regular Azul Profundo', precio: 26990, tallas: ['M', 'L', 'XL'], colores: ['Azul profundo'], imagen: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Regular fit para rotacion diaria.' },
    { nombre: 'Pantalon Sastre Gris Oxford', precio: 32490, tallas: ['M', 'L'], colores: ['Gris oxford'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Silueta limpia para agenda formal.' },
    { nombre: 'Pantalon Casual Avellana', precio: 26490, tallas: ['S', 'M', 'L'], colores: ['Avellana'], imagen: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Pantalon neutro facil de combinar.' },
]
...
const hombreTrajes: ProductSeed[] = [
    ...
    { nombre: 'Traje Cruzado Azul Noche', precio: 108990, tallas: ['M', 'L', 'XL'], colores: ['Azul noche'], imagen: 'https://images.unsplash.com/photo-1593032465175-481ac7f401a0?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Traje cruzado para presencia formal.' },
    { nombre: 'Traje Slim Arena Formal', precio: 95990, tallas: ['M', 'L'], colores: ['Arena'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Slim fit claro para eventos diurnos.' },
    { nombre: 'Traje Ejecutivo Negro Mate', precio: 99990, tallas: ['L', 'XL'], colores: ['Negro mate'], imagen: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Negro sobrio con caida definida.', nuevo: true },
    { nombre: 'Traje Ceremonia Azul Petroleo', precio: 103990, tallas: ['M', 'L'], colores: ['Azul petroleo'], imagen: 'https://images.unsplash.com/photo-1593032465175-481ac7f401a0?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Traje refinado con tono profundo.' },
    { nombre: 'Traje Clasico Gris Ceniza', precio: 91990, tallas: ['M', 'L', 'XL'], colores: ['Gris ceniza'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Clasico de lectura pulida para oficina.' },
    { nombre: 'Traje Premium Verde Oscuro', precio: 109990, tallas: ['L', 'XL'], colores: ['Verde oscuro'], imagen: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Opcion premium para rotacion formal.' },
    { nombre: 'Traje Regular Grafito', precio: 93990, tallas: ['M', 'L'], colores: ['Grafito'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Regular fit con tono ejecutivo.' },
    { nombre: 'Traje Italiano Azul Cobalto', precio: 112990, tallas: ['M', 'L', 'XL'], colores: ['Azul cobalto'], imagen: 'https://images.unsplash.com/photo-1593032465175-481ac7f401a0?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Corte italiano con fuerte presencia.' },
    { nombre: 'Traje Oficina Gris Pizarra', precio: 94990, tallas: ['M', 'L'], colores: ['Gris pizarra'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Listo para jornadas ejecutivas.' },
    { nombre: 'Traje Ceremonia Marengo', precio: 104990, tallas: ['L', 'XL'], colores: ['Marengo'], imagen: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Tono profundo para ocasiones especiales.' },
    { nombre: 'Traje Dos Piezas Piedra', precio: 90990, tallas: ['M', 'L', 'XL'], colores: ['Piedra'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Dos piezas claro con perfil moderno.' },
    { nombre: 'Traje Slim Azul Acuarela', precio: 97990, tallas: ['M', 'L'], colores: ['Azul acuarela'], imagen: 'https://images.unsplash.com/photo-1593032465175-481ac7f401a0?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Slim con tela ligera y limpia.' },
    { nombre: 'Traje Formal Carbon Intenso', precio: 101990, tallas: ['L', 'XL'], colores: ['Carbon intenso'], imagen: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Formal masculino de tono firme.' },
    { nombre: 'Traje Ejecutivo Azul Tinta', precio: 96990, tallas: ['M', 'L', 'XL'], colores: ['Azul tinta'], imagen: 'https://images.unsplash.com/photo-1593032465175-481ac7f401a0?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Ejecutivo versatil para oficina y evento.', nuevo: true },
    { nombre: 'Traje Ceremony Gris Perla', precio: 105990, tallas: ['M', 'L'], colores: ['Gris perla'], imagen: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Opcion clara con acabado premium.' },
]
...
const hombreAccesorios: ProductSeed[] = [
    ...
    { nombre: 'Cinturon Reversible Negro Cafe', precio: 16990, tallas: ['M', 'L', 'XL'], colores: ['Negro', 'Cafe'], imagen: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Cinturon de doble faz para mayor uso.' },
    { nombre: 'Corbata Microprint Gris', precio: 14990, tallas: ['S', 'M'], colores: ['Gris'], imagen: 'https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Microprint discreto para oficina.' },
    { nombre: 'Billetera Vertical Negro Mate', precio: 19990, tallas: ['S', 'M'], colores: ['Negro mate'], imagen: 'https://images.unsplash.com/photo-1627123424574-724758594e93?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Formato vertical de lectura sobria.', nuevo: true },
    { nombre: 'Panuelo de Bolsillo Plata', precio: 12990, tallas: ['S', 'M'], colores: ['Plata'], imagen: 'https://images.unsplash.com/photo-1589756823695-278bc923f962?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Detalle elegante para conjuntos formales.' },
    { nombre: 'Bufanda Canalete Beige', precio: 18490, tallas: ['M', 'L'], colores: ['Beige'], imagen: 'https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Textura suave para temporada fresca.' },
    { nombre: 'Pulsera Acero Negro', precio: 14990, tallas: ['S', 'M'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Pulsera minimal con herraje oscuro.' },
    { nombre: 'Corbata Rayas Burdeos', precio: 15990, tallas: ['S', 'M'], colores: ['Burdeos'], imagen: 'https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Rayas finas para un look ejecutivo.' },
    { nombre: 'Cinturon Suede Arena', precio: 17990, tallas: ['M', 'L'], colores: ['Arena'], imagen: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Acabado suede para estilismo casual.' },
    { nombre: 'Porta Pasaporte Cafe Oscuro', precio: 18990, tallas: ['S', 'M'], colores: ['Cafe oscuro'], imagen: 'https://images.unsplash.com/photo-1627123424574-724758594e93?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Accesorio practico con lectura premium.' },
    { nombre: 'Panuelo Marino Geometrico', precio: 12990, tallas: ['S', 'M'], colores: ['Marino'], imagen: 'https://images.unsplash.com/photo-1589756823695-278bc923f962?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Geometria discreta para blazer.' },
    { nombre: 'Llavero Trenzado Camel', precio: 10990, tallas: ['S', 'M'], colores: ['Camel'], imagen: 'https://images.unsplash.com/photo-1606760227091-3dd870d97f1d?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Cuero trenzado con acabado simple.' },
    { nombre: 'Corbata Seda Negra', precio: 16990, tallas: ['S', 'M'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Seda sobria para eventos nocturnos.' },
    { nombre: 'Pulsera Cuero Azul Marino', precio: 13990, tallas: ['S', 'M'], colores: ['Azul marino'], imagen: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Pulsera casual de tono profundo.' },
    { nombre: 'Bufanda Gris Espiga', precio: 18990, tallas: ['M', 'L'], colores: ['Gris'], imagen: 'https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Patron espiga para clima fresco.' },
    { nombre: 'Tarjetero Negro Texturizado', precio: 15990, tallas: ['S', 'M'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1627123424574-724758594e93?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Tarjetero delgado con textura fina.', nuevo: true },
]
...
const mujerBlusas: ProductSeed[] = [
    ...
    { nombre: 'Blusa Lazo Azul Humo', precio: 24990, tallas: ['S', 'M', 'L'], colores: ['Azul humo'], imagen: 'https://images.unsplash.com/photo-1554412933-514a83d2f3c8?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Lazo al cuello con aire ejecutivo.' },
    { nombre: 'Blusa Marfil Texturada', precio: 22990, tallas: ['S', 'M', 'L'], colores: ['Marfil'], imagen: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Textura fina para uso diario.' },
    { nombre: 'Blusa Satin Verde Agua', precio: 25990, tallas: ['M', 'L'], colores: ['Verde agua'], imagen: 'https://images.unsplash.com/photo-1618244972963-dbee1a7edc95?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Satin liviano con brillo sutil.', nuevo: true },
    { nombre: 'Blusa Cuello V Arena', precio: 23490, tallas: ['S', 'M', 'L'], colores: ['Arena'], imagen: 'https://images.unsplash.com/photo-1485968579580-b6d095142e6e?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Cuello V facil de combinar.' },
    { nombre: 'Blusa Estampado Azul Petalo', precio: 24490, tallas: ['S', 'M'], colores: ['Azul petalo'], imagen: 'https://images.unsplash.com/photo-1554412933-514a83d2f3c8?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Estampado suave para oficina.' },
    { nombre: 'Blusa Negra Satin Recta', precio: 26990, tallas: ['M', 'L'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1618244972963-dbee1a7edc95?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Base elegante de caida limpia.' },
    { nombre: 'Blusa Rosa Nude Ligera', precio: 22490, tallas: ['S', 'M', 'L'], colores: ['Rosa nude'], imagen: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Tela ligera para clima calido.' },
    { nombre: 'Blusa Manga Abullonada Blanca', precio: 25490, tallas: ['S', 'M', 'L'], colores: ['Blanco'], imagen: 'https://images.unsplash.com/photo-1485968579580-b6d095142e6e?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Volumen suave con lectura femenina.' },
    { nombre: 'Blusa Azul Marino Formal', precio: 26490, tallas: ['M', 'L'], colores: ['Azul marino'], imagen: 'https://images.unsplash.com/photo-1554412933-514a83d2f3c8?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Prenda pulida para agenda laboral.' },
    { nombre: 'Blusa Lavanda Soft', precio: 23990, tallas: ['S', 'M'], colores: ['Lavanda'], imagen: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Color suave con silueta relajada.' },
    { nombre: 'Blusa Verde Bosque Premium', precio: 27990, tallas: ['M', 'L'], colores: ['Verde bosque'], imagen: 'https://images.unsplash.com/photo-1618244972963-dbee1a7edc95?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Tono profundo con acabado premium.' },
    { nombre: 'Blusa Crema Con Pliegues', precio: 24990, tallas: ['S', 'M', 'L'], colores: ['Crema'], imagen: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Pliegues frontales de perfil elegante.' },
    { nombre: 'Blusa Vino Manga Suelta', precio: 25990, tallas: ['M', 'L'], colores: ['Vino'], imagen: 'https://images.unsplash.com/photo-1485968579580-b6d095142e6e?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Manga suelta para un look refinado.' },
    { nombre: 'Blusa Gris Perla Oficinista', precio: 22990, tallas: ['S', 'M', 'L'], colores: ['Gris perla'], imagen: 'https://images.unsplash.com/photo-1554412933-514a83d2f3c8?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Ideal para combinaciones sastre.' },
    { nombre: 'Blusa Coral Satin Premium', precio: 26990, tallas: ['S', 'M'], colores: ['Coral'], imagen: 'https://images.unsplash.com/photo-1618244972963-dbee1a7edc95?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Satin con tono vivo y elegante.', nuevo: true },
]
...
const mujerPantalones: ProductSeed[] = [
    ...
    { nombre: 'Jean Bootcut Azul Medio', precio: 26990, tallas: ['S', 'M', 'L'], colores: ['Azul medio'], imagen: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Bootcut clasico para rotacion diaria.' },
    { nombre: 'Pantalon Palazzo Marfil', precio: 31490, tallas: ['S', 'M', 'L'], colores: ['Marfil'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Palazzo fluido con presencia refinada.' },
    { nombre: 'Pantalon Sastre Azul Tinta', precio: 30490, tallas: ['M', 'L', 'XL'], colores: ['Azul tinta'], imagen: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Base ejecutiva para oficina.', nuevo: true },
    { nombre: 'Jean Recto Grafito', precio: 25990, tallas: ['S', 'M'], colores: ['Grafito'], imagen: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Recto moderno de tono oscuro.' },
    { nombre: 'Pantalon Camel Estructurado', precio: 28990, tallas: ['S', 'M', 'L'], colores: ['Camel'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Tela firme con silueta limpia.' },
    { nombre: 'Wide Leg Azul Humo', precio: 32490, tallas: ['M', 'L'], colores: ['Azul humo'], imagen: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Wide leg con tono suave y actual.' },
    { nombre: 'Pantalon Recto Verde Musgo', precio: 27990, tallas: ['S', 'M', 'L'], colores: ['Verde musgo'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Color natural para looks calmados.' },
    { nombre: 'Jean Slim Carbon', precio: 26990, tallas: ['S', 'M', 'L'], colores: ['Carbon'], imagen: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Slim oscuro con lavado uniforme.' },
    { nombre: 'Pantalon Negro Costura Frontal', precio: 30990, tallas: ['M', 'L', 'XL'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Costura frontal para lectura elegante.' },
    { nombre: 'Pantalon Arena Liviano', precio: 26490, tallas: ['S', 'M'], colores: ['Arena'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Pieza ligera para clima calido.' },
    { nombre: 'Wide Leg Gris Piedra', precio: 31990, tallas: ['S', 'M', 'L'], colores: ['Gris piedra'], imagen: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Volumen amplio con tono neutro.' },
    { nombre: 'Jean Azul Deslavado Soft', precio: 24990, tallas: ['S', 'M', 'L'], colores: ['Azul deslavado'], imagen: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Denim relajado de uso frecuente.' },
    { nombre: 'Pantalon Sastre Rosa Palo', precio: 29990, tallas: ['M', 'L'], colores: ['Rosa palo'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Sastre suave con tono femenino.' },
    { nombre: 'Pantalon Azul Marino Stretch', precio: 29490, tallas: ['M', 'L', 'XL'], colores: ['Azul marino'], imagen: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Stretch comodo para agenda extensa.' },
    { nombre: 'Pantalon Beige Texturizado', precio: 28490, tallas: ['S', 'M', 'L'], colores: ['Beige'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Textura sutil para elevar el basico.' },
]
...
const mujerFormal: ProductSeed[] = [
    ...
    { nombre: 'Vestido Midi Verde Bosque', precio: 58990, tallas: ['S', 'M', 'L'], colores: ['Verde bosque'], imagen: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Vestido midi para eventos y oficina.' },
    { nombre: 'Conjunto Sastre Azul Humo', precio: 60990, tallas: ['M', 'L'], colores: ['Azul humo'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Sastre femenino de tono elegante.' },
    { nombre: 'Blazer Largo Negro Premium', precio: 54990, tallas: ['S', 'M', 'L'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Blazer largo con estructura moderna.', nuevo: true },
    { nombre: 'Set Formal Rosa Empolvado', precio: 56990, tallas: ['S', 'M'], colores: ['Rosa empolvado'], imagen: 'https://images.unsplash.com/photo-1485968579580-b6d095142e6e?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Formal suave con silueta femenina.' },
    { nombre: 'Vestido Recto Grafito', precio: 53990, tallas: ['M', 'L'], colores: ['Grafito'], imagen: 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Recto sobrio para agenda ejecutiva.' },
    { nombre: 'Blazer Crema Boton Dorado', precio: 51990, tallas: ['S', 'M', 'L'], colores: ['Crema'], imagen: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Blazer claro con detalle metalico.' },
    { nombre: 'Conjunto Oficina Verde Salvia', precio: 57990, tallas: ['M', 'L'], colores: ['Verde salvia'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Conjunto sobrio de tono actual.' },
    { nombre: 'Vestido Formal Marfil Perla', precio: 64990, tallas: ['S', 'M', 'L'], colores: ['Marfil perla'], imagen: 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Opcion refinada para eventos diurnos.' },
    { nombre: 'Set Ejecutivo Azul Marino', precio: 61990, tallas: ['M', 'L', 'XL'], colores: ['Azul marino'], imagen: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Set definido para reuniones y oficina.' },
    { nombre: 'Blazer Rosa Palo Estructurado', precio: 52990, tallas: ['S', 'M'], colores: ['Rosa palo'], imagen: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Estructura limpia con tono suave.' },
    { nombre: 'Conjunto Gris Oxford Formal', precio: 58990, tallas: ['M', 'L'], colores: ['Gris oxford'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Formal femenino de lectura clasica.' },
    { nombre: 'Vestido Azul Petroleo Premium', precio: 65990, tallas: ['S', 'M', 'L'], colores: ['Azul petroleo'], imagen: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Vestido premium con tono profundo.', nuevo: true },
    { nombre: 'Set Arena Claro Elegante', precio: 59990, tallas: ['S', 'M', 'L'], colores: ['Arena clara'], imagen: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Set elegante de base neutra.' },
    { nombre: 'Blazer Negro Solapa Satin', precio: 55990, tallas: ['M', 'L'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Solapa satinada para una lectura formal.' },
    { nombre: 'Conjunto Lavanda Ejecutivo', precio: 57490, tallas: ['S', 'M'], colores: ['Lavanda'], imagen: 'https://images.unsplash.com/photo-1485968579580-b6d095142e6e?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Conjunto fresco para oficina moderna.' },
]
...
const mujerAccesorios: ProductSeed[] = [
    ...
    { nombre: 'Bolso Tote Negro Mate', precio: 24990, tallas: ['S', 'M'], colores: ['Negro mate'], imagen: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Tote sobrio de uso amplio.' },
    { nombre: 'Cartera Azul Humo Compacta', precio: 18490, tallas: ['S', 'M'], colores: ['Azul humo'], imagen: 'https://images.unsplash.com/photo-1594223274512-ad4803739b7c?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Compacta con lectura elegante.' },
    { nombre: 'Cinturon Camel Hebilla Redonda', precio: 16990, tallas: ['S', 'M', 'L'], colores: ['Camel'], imagen: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Cinturon fino para marcar la silueta.', nuevo: true },
    { nombre: 'Collar Plata Minimal Largo', precio: 14990, tallas: ['S', 'M'], colores: ['Plata'], imagen: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Collar discreto para capas ligeras.' },
    { nombre: 'Aretes Dorado Cepillado', precio: 13990, tallas: ['S', 'M'], colores: ['Dorado'], imagen: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Acabado cepillado de perfil moderno.' },
    { nombre: 'Bolso Hobo Arena', precio: 23990, tallas: ['S', 'M'], colores: ['Arena'], imagen: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Bolso flexible para uso diario.' },
    { nombre: 'Panuelo Floral Vino', precio: 12990, tallas: ['S', 'M'], colores: ['Vino'], imagen: 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Toque femenino para bolso o cuello.' },
    { nombre: 'Cartera Rosa Palo Premium', precio: 19490, tallas: ['S', 'M'], colores: ['Rosa palo'], imagen: 'https://images.unsplash.com/photo-1594223274512-ad4803739b7c?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Cartera premium de tono suave.' },
    { nombre: 'Cinturon Negro Hebilla Dorada', precio: 15990, tallas: ['S', 'M', 'L'], colores: ['Negro'], imagen: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Basico elegante con detalle dorado.' },
    { nombre: 'Collar Perla Moderna', precio: 16990, tallas: ['S', 'M'], colores: ['Perla'], imagen: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Perlas con lectura actual.' },
    { nombre: 'Bolso Mini Marfil', precio: 21990, tallas: ['S', 'M'], colores: ['Marfil'], imagen: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Bolso pequeno para salidas y eventos.' },
    { nombre: 'Aretes Cristal Azul', precio: 14990, tallas: ['S', 'M'], colores: ['Azul'], imagen: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Cristal sutil con tono frio.' },
    { nombre: 'Panuelo Seda Coral', precio: 12990, tallas: ['S', 'M'], colores: ['Coral'], imagen: 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Seda ligera para acento de color.' },
    { nombre: 'Cartera Verde Salvia Soft', precio: 17990, tallas: ['S', 'M'], colores: ['Verde salvia'], imagen: 'https://images.unsplash.com/photo-1594223274512-ad4803739b7c?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Cartera suave con tono actual.' },
    { nombre: 'Pulsera Fina Plateada', precio: 12990, tallas: ['S', 'M'], colores: ['Plata'], imagen: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?auto=format&fit=crop&w=400&h=500&q=80', descripcion: 'Pulsera discreta para uso diario.', nuevo: true },
]

export const products: Product[] = [
    ...createCategoryProducts('hombre', 'camisas', hombreCamisas, 1),
    ...createCategoryProducts('hombre', 'pantalones', hombrePantalones, 31),
    ...createCategoryProducts('hombre', 'trajes', hombreTrajes, 61),
    ...createCategoryProducts('hombre', 'accesorios', hombreAccesorios, 91),
    ...createCategoryProducts('mujer', 'blusas', mujerBlusas, 121),
    ...createCategoryProducts('mujer', 'pantalones', mujerPantalones, 151),
    ...createCategoryProducts('mujer', 'ropa-formal', mujerFormal, 181),
    ...createCategoryProducts('mujer', 'accesorios', mujerAccesorios, 211),
]
